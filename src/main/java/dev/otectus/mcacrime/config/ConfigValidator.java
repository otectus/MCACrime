...
public final class ConfigValidator {
     ...
     * {@code jail.enableFines} off there is never anything for it to be an alternative to:
     * {@code SettlementPolicy} refuses to quote, every offer is declined, and an operator reading
     * {@code communityService = true} would reasonably believe their players had a way to work off a
     * case. Kept out of the capability table on purpose -- that table answers "what does the installed
     * Townstead provide", and this is a question about MCA: Crime's own settings.
     *
