...
public final class CrimeDetectionHandlers {
     ...
     * {@code isDeadOrDying()}, when {@link DamageIncidentService#flush} runs at the END of the server
     * tick. A death that was cancelled — at any priority, before or after this handler — resolves as
     * {@code HARM} or {@code NONE} there, so the finality pipeline, the death consequences and the
     * custody cleanup only ever run for a death that actually completed.
     *
