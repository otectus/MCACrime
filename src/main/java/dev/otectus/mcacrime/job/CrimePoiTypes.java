 ...
 *
 * <p>NeoForge attaches the block-state mapping itself, through {@code
 * NeoForgeRegistryCallbacks.PoiTypeCallbacks} on the POI registry, so nothing here calls vanilla's
 * private {@code PoiTypes.registerBlockStates} and this mod still needs no access transformer.
 */
public final class CrimePoiTypes {

    public static final DeferredRegister<PoiType> POI_TYPES =
            DeferredRegister.create(Registries.POINT_OF_INTEREST_TYPE, McaCrime.MOD_ID);
    ...
    public static final DeferredHolder<PoiType, PoiType> MASK_STATION =
            POI_TYPES.register("mask_station", () -> new PoiType(states(), 1, 1));
