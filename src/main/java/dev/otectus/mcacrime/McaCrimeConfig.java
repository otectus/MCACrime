...
public final class McaCrimeConfig {
    ...
    public static final class Common {
        ...
        // --- mask (0.7.0) ---
        public final ForgeConfigSpec.BooleanValue maskEnabled;
        public final ForgeConfigSpec.BooleanValue maskSuppressesHeat;
        public final ForgeConfigSpec.BooleanValue maskDefersHeat;
        public final ForgeConfigSpec.BooleanValue maskHidesIdentityFromWitnesses;
        public final ForgeConfigSpec.IntValue maskedPursuitTicks;
        public final ForgeConfigSpec.BooleanValue maskedOffenderLethalForce;
        public final ForgeConfigSpec.BooleanValue maskSuppressesRedBandTargeting;
        public final ForgeConfigSpec.BooleanValue guardsChallengeMaskWearers;
        public final ForgeConfigSpec.IntValue maskedHeatExpiryTicks;
        public final ForgeConfigSpec.DoubleValue maskRemovalWitnessRadius;
        public final ForgeConfigSpec.BooleanValue maskDurabilityEnabled;

        // --- mask station (0.7.2 §6, §8) ---
        public final ForgeConfigSpec.BooleanValue enableMaskStationCrafting;
        public final ForgeConfigSpec.BooleanValue enableMaskRestyling;

        // --- sand bottle (0.7.2 §13) ---
        public final ForgeConfigSpec.BooleanValue enableSandBottles;
        public final ForgeConfigSpec.IntValue sandCooldownTicks;
        public final ForgeConfigSpec.IntValue sandDirectDurationTicks;
        public final ForgeConfigSpec.IntValue sandSplashDurationTicks;
        public final ForgeConfigSpec.DoubleValue sandRadius;
        public final ForgeConfigSpec.IntValue sandRecoveryTicks;
        public final ForgeConfigSpec.BooleanValue sandAffectsPlayers;
        ...
        public final ForgeConfigSpec.EnumValue<dev.otectus.mcacrime.memory.ApologyInteractionPolicy.Mode> emptyHandApologyMode;
        ...
        public final ForgeConfigSpec.ConfigValue<String> currencyItem;
        ...
        Common(ForgeConfigSpec.Builder b) {
            ...
            currencyItem = b.comment(
                    "The item 'mcacrime:item' pays in, as a registry id. Only paid in when currencyId",
                    "is 'mcacrime:item'; validated regardless. Any registered item works, and one item",
                    "counts as one unit. An unknown or absent item falls back to emeralds with one",
                    "warning.")
    ...
    public static final class Client {
        ...
        public final ForgeConfigSpec.BooleanValue maskHidesNameTag;
        public final ForgeConfigSpec.EnumValue<SandParticleMode> sandParticles;
