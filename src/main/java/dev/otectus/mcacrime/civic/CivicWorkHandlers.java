...
public final class CivicWorkHandlers {
     ...
     *
     * <p>{@code ServerTickEvent.Post} is NeoForge 1.21.1's end-of-tick event — the split halves of the
     * Forge-era phased {@code TickEvent.ServerTickEvent} — so the sweep runs after every level has
     * finished ticking, which is where a claim renewal belongs: nothing else is going to move the
     * villager afterwards this tick.
     */
    @SubscribeEvent
