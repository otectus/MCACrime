 ...
 *
 * <p>Nothing is added to the spawn packet. 1.21.1 spawns thrown entities with vanilla's own
 * {@code ClientboundAddEntityPacket}, and every field this class carries is launch provenance the
 * server alone reads — the client draws an item and needs none of it.
 */
