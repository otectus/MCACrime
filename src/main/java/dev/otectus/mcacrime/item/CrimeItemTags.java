...
public final class CrimeItemTags {
    ...
    public static final TagKey<Item> FENCE_BLACKLIST =
            ItemTags.create(McaCrime.id("fence_blacklist"));
