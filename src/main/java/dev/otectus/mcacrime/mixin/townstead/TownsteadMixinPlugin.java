...
public final class TownsteadMixinPlugin implements IMixinConfigPlugin {
    ...
    /**
     * Null, and on this platform that is the only answer there is.
     *
     * <p>NeoForge 1.21.1 runs on Mojang names in production, so this mod builds with no Mixin
     * annotation processor and generates no refmap at all — neither this config nor
     * {@code mcacrime.mixins.json} declares one. Returning a name here would point Mixin at a file
