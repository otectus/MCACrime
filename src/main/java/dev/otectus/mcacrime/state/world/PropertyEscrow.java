...
public final class PropertyEscrow {
     ...
     * binding pushes an item through {@code Inventory.add}, which returns false and leaves the
     * overflow in the stack it was given, so the remainder is exactly what that call did not take.
     */
    @FunctionalInterface
