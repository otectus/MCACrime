...
public final class TownsteadRolePolicy {
     ...
     * switch has to be on. Wrapped because a unit test and a dedicated CLI have no config, and off is
     * the answer that leaves guard recruitment exactly as it behaved before Townstead existed.
     */
