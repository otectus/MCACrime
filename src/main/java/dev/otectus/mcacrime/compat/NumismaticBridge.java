 ...
 *
 * <p>If the attachment class moves, or a method is renamed in a future Numismatic, this bridge logs one
...
public final class NumismaticBridge {
    ...
    public static void registerIfPresent() {
        ...
        try {
            ...
            return; // no mod loader around us (tests, or far too early); nothing to integrate with
        }
        try {
            ...
            McaCrime.LOGGER.warn("MCA: Crime found Numismatic Overhaul but could not bind to its purse "
                    + "attachment; 'mcacrime:numismatic' will not be offered.", failure);
        }
    }
}
