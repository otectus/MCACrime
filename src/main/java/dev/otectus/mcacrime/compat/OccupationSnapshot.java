 ...
 * @param offers        the initialised offers, serialised. NBT rather than the live object because a
 *                      {@code MerchantOffers} handed back by reference would be mutated by the same
 *                      profession change this snapshot exists to undo.
 */
