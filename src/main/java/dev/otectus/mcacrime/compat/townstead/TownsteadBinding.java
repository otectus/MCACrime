...
public final class TownsteadBinding {
     ...
     * type rather than from anything this mod compiles against. Returns e.g. {@code "net.conczin.mca"},
     * which is the root every 1.21.1 NeoForge MCA build ships.
     ...
     * initialiser, which would register content and touch MCA before NeoForge is ready for it.
     */
    @Nullable
