...
class GuardChallengeTextTest {
    ...
    @Test void serializedChatPreservesBothTheTranslationKeyAndFallback() {
        language(Map.of());
        var message = GuardChallengeText.detentionReason(decision(LegalDecision.Basis.WANTED));
        String encoded = Component.Serializer.toJson(message, net.minecraft.core.RegistryAccess.EMPTY);
        ...
        var received = Component.Serializer.fromJson(encoded, net.minecraft.core.RegistryAccess.EMPTY);
