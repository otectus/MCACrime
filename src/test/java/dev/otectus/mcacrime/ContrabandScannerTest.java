...
class ContrabandScannerTest {
    ...
    private static ContrabandProbe probe(ContrabandSlot slot, int depth) {
        return new ContrabandProbe(new ResourceLocation("minecraft:tnt"), tag -> false, 1, depth,
                "TNT", slot);
    }
    ...
    void unlistedItemsAndAnEmptyRuleSetFindNothing() {
        ContrabandProbe stone = new ContrabandProbe(new ResourceLocation("minecraft:stone"), tag -> false,
