...
class FenceOfferBuilderTest {
    ...
    private static FenceGoodsRegistry stocked() {
        ...
        registry.contribute(ResourceLocation.fromNamespaceAndPath("minecraft", "gunpowder"), 4L, false, true);
        registry.contribute(ResourceLocation.fromNamespaceAndPath("minecraft", "ender_pearl"), 12L, true, false);
        registry.contribute(ResourceLocation.fromNamespaceAndPath("mcacrime", "restraint_rope"), 6L, true, true);
        registry.contribute(ResourceLocation.fromNamespaceAndPath("mcacrime", "restraint_cuffs"), 12L, true, true);
        registry.contribute(ResourceLocation.fromNamespaceAndPath("locks", "iron_lock_pick"), 6L, true, false);
        return registry;
    }
