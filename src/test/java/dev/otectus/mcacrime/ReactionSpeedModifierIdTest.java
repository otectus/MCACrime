...
class ReactionSpeedModifierIdTest {
    ...
    void theModifierIdIsStableAcrossReleases() {
        assertEquals("mcacrime:civilian_reaction_speed", ReactionSpeedModifier.MODIFIER_ID.toString());
    }

    @Test
    void theMultipliedTotalAmountIsTheMultiplierMinusOne() {
        // A frozen victim needs a full -1.0: ADD_MULTIPLIED_TOTAL with anything less still leaves them
        // able to walk out of the mugging, and a sign error here would make them faster instead.
