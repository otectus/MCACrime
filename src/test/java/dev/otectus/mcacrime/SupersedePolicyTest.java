...
class SupersedePolicyTest {
    ...
    private static final CrimeCommunityKey VILLAGE =
            CrimeCommunityKey.of(new ResourceLocation("minecraft", "overworld"), 0).orElseThrow();
    private static final CrimeCommunityKey OTHER_VILLAGE =
            CrimeCommunityKey.of(new ResourceLocation("minecraft", "overworld"), 1).orElseThrow();
