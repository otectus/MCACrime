...
class DeathConsequencesTest {
    ...
    private final Warrant warrant = Warrant.open(UUID.randomUUID(), target,
            new ResourceLocation("mcacrime", "murder_player"), UUID.randomUUID(), 10);
    ...
    @Test void futureStoreCannotAcquireADeathReward() {
        ...
        assertFalse(BountyService.claimKill(CrimeWorldData.load(tag), offer(true, true), true, true, "mcacrime:emerald", 30).claimed());
    }
}
