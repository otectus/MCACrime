...
class ReviewCapacityRegressionTest {
    ...
    @Test void fullStolenGoodsTablePreventsRemoval() {
        ...
        assertTrue(StolenGoodsLedger.commitTheft(data, UUID.randomUUID(), THIEF, OWNER, "test:bank", 1,
    ...
    @Test void theftReservationProtectsLastSlotAndRejectsReentry() {
        ...
        UUID id = UUID.randomUUID();
        assertTrue(StolenGoodsLedger.commitTheft(data, id, THIEF, OWNER, "test:bank", 1, () -> {
        ...
        assertTrue(StolenGoodsLedger.commitTheft(data, id, THIEF, OWNER, "test:bank", 2,
