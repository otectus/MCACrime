...
class WantedPursuitTest {
    ...
    @Test void readOnlyFutureDataCannotAuthorizeAnArrestEvenWithWantedHeat() {
        CompoundTag tag = new CrimeWorldData().save(new CompoundTag(), net.minecraft.core.RegistryAccess.EMPTY);
        tag.putInt("schema", Integer.MAX_VALUE);
        assertFalse(assess(CrimeWorldData.load(tag, net.minecraft.core.RegistryAccess.EMPTY), 100, 50, true).mayChallenge());
    }
}
